...
import com.example.shramvriddhi.databinding.ActivityOtpBinding
...
class OtpActivity : AppCompatActivity() {
    ...
    private fun init() {
        ...
        verifyBtn = binding.BtnOtpSubmit
        resendTV =  binding.tvResend
        inputOTP1 = binding.etOtpFill1
        inputOTP2 = binding.etOtpFill2
        inputOTP3 = binding.etOtpFill3
        inputOTP4 = binding.etOtpFill4
        inputOTP5 = binding.etOtpFill5
        inputOTP6 = binding.etOtpFill6
    }
